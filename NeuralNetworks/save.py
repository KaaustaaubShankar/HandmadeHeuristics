...
activation_functions = {
    ...
    'softmax': (softmax, None)  # Softmax derivative not needed due to separate handling in output layer
}
...
# Get user inputs for hidden layer sizes and learning rate
...
train(network, x_train, y_train, alpha, epochs, mse_loss, mse_gradient)
